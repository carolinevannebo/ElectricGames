...
import { GamePage, GetAllGamesPage, GetGameByIdPage, GetGameByTitlePage, GetGamesByGenrePage, GetGamesByDeveloperPage } from './pages/index';
      ...
      <main className='container'>
        <Routes>
          ...
          <Route path='/games/*' element={<GamePage/>}>
            ...
            <Route path='games/update-game' element={<GamePage/>}></Route>
          </Route>
